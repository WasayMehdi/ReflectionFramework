...
public final class ReflectionUtils {
    ...
    public static Field getField(final Class<?> clazz, final String name){
        try{
            final Field f = clazz.getDeclaredField(Config.get(name));
    ...
    public static Method getMethod(final Class<?> clazz, final String name, final Class<?>... paramList){
        try{
            final Method m = clazz.getDeclaredMethod(Config.get(name), paramList);
    ...
    public static Class<?> getClass(final ClassLoader cl, final String name){
        try{
            return cl.loadClass(Config.get(name));
        }catch(Exception ex){
        	ex.printStackTrace();
            return null;
        }
